...
const Searchbar = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className="w-full sm:w-6/12 px-1 sm:px-4 py-1.5 flex justify-between items-center shadow-md bg-white rounded-sm overflow-hidden">
